...
namespace Opc.Ua.PubSub {
    ...
    /// </summary>
    public class DataSetMetaDataMessage : IEncodeable {
        ...
        /// <inheritdoc/>
        public static DataSetMetaDataMessage Decode(ServiceMessageContext context, StreamReader reader) {
            var json = reader.ReadToEnd();

            var output = new DataSetMetaDataMessage();
